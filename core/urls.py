...
from .views import cambiarEstadoF, cambiarEstado, charcha_serviceworker, manifest, base_layout, ListarProducto, index, eliminarProducto, actualizarProducto, formularioProducto, formularioLista, listarLista, eliminarLista, actualizarLista, listarProductoFiltro
...
urlpatterns = [
    ...
    path('cambiarEstadoF', cambiarEstadoF, name='cambiarEstadoF'),
